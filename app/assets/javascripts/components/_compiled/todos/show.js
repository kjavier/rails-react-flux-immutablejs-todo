modulejs.define('todoShow', ['react', 'immutableRenderMixin', 'todoStore', 'todoActions', 'todoForm'],
  ...
  var view = React.createClass({
    ...
    render: function() {
      return (
        React.createElement("a", {href: "javascript:;", className: "list-group-item", ref: "todoShow", onClick: this._onClick}, 
          React.createElement(TodoForm, {ref: "editForm", model: this.props.model, editingEnabled: this.state.editingEnabled, 
